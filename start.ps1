...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2qi2wn0epen4w-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert escrita-DB.cert.pem --key escrita-DB.private.key --client_id basicPubSub --topic sdk/test/python --count 0